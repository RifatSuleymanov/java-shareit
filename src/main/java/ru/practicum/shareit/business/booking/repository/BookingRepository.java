package ru.practicum.shareit.business.booking.repository;
...
public interface BookingRepository extends JpaRepository<Booking, Integer> {
    ...
    List<Booking> findTop1BookingByItemIdAndStartIsBeforeAndStatusIs(int id, LocalDateTime now, BookingStatus approved, Sort start);

    List<Booking> findTop1BookingByItemIdAndStartIsAfterAndStatusIs(int id, LocalDateTime now, BookingStatus approved, Sort start);
}